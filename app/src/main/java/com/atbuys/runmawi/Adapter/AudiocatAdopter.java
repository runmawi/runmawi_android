...
import com.atbuys.runmawi.CategoryAudiosPageActivity;
...
public class AudiocatAdopter extends RecyclerView.Adapter<AudiocatAdopter.HomeViewHolder> {
    ...
    public AudiocatAdopter(ArrayList<HomeData> genre_movies, Context context) {
    ...
    public void onBindViewHolder(@NonNull HomeViewHolder holder, final int position) {
       ...
       /* if(genre_movies.get(position).getMessage().equalsIgnoreCase("nodata")) {
           ...
           // holder.nodata.setText(genre_movies.get(position).getMessage());
            ...
            videoAdapter = new AudioAdapter(Arrays.asList(genre_movies.get(position).getAudios()), context);
        ...
        public HomeViewHolder(View itemView) {
            ...
            textViewCategory.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent in=new Intent(context, CategoryAudiosPageActivity.class);
