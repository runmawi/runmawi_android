...
import com.atbuys.runmawi.LiveStreamPageActivity;
...
public class Home1Adapter extends RecyclerView.Adapter<Home1Adapter.HomeViewHolder> {
    ...
    public Home1Adapter(ArrayList<HomeData1> genre_movies, Context context) {
        this.live_streams = genre_movies;
    ...
    public HomeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View theView = LayoutInflater.from(context).inflate(R.layout.row_layout_home1, parent, false);
    ...
    public void onBindViewHolder(@NonNull HomeViewHolder holder, final int position) {
       ...
       // holder.textViewCategory.setText(live_streams.get(position).getGenreName());
        holder.textViewCategoryid.setText(live_streams.get(position).getGenre_id());

        //Log.d("dfdcsdzczxczcx",live_streams.get(position).getGenre_id());
                if(live_streams.get(position).getMessage().equalsIgnoreCase("nodata")) {
           ...
           // holder.nodata.setText(genre_movies.get(position).getMessage());
            ...
            videoAdapter = new LiveVideoAdapter(Arrays.asList(live_streams.get(position).getVideos()), context);
        ...
        public HomeViewHolder(View itemView) {
            ...
            textViewCategory.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent in=new Intent(context, LiveStreamPageActivity.class);
