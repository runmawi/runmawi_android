...
public class HomePageVideoAdapter extends RecyclerView.Adapter<HomePageVideoAdapter.MovieViewHolder> {
    ...
    public HomePageVideoAdapter(List<data> list, Context context) {
        this.movieList = list;
    ...
    public MovieViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MovieViewHolder(LayoutInflater.from(context).inflate(R.layout.row_layout_channel, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull final MovieViewHolder holder, final int position) {
      ...
      //  holder.textsub.setText(moviesubtitles.get(position).getUrl());
        ...
        holder.textViewCategory.setText(movie1.getId());
        holder.textViewCategoryid.setText(movie1.getImage_url());


        //String txt=movie.getId();


      holder.textViewCategory.setText(movie1.getMobile_image());
        ...
        public MovieViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                   ...
                   // Toast.makeText(context,""+textViewTitle.getText().toString(),Toast.LENGTH_LONG).show();
