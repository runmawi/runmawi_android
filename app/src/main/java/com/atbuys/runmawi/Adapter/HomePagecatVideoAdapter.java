...
import com.atbuys.runmawi.Model.category_videos;
...
public class HomePagecatVideoAdapter extends RecyclerView.Adapter<HomePagecatVideoAdapter.MovieViewHolder> {


    private List<category_videos> movieList;
    private Context context;
    category_videos movie1;
    ...
    public HomePagecatVideoAdapter(List<category_videos> list, Context context) {
        this.movieList = list;
    ...
    public void onBindViewHolder(@NonNull final MovieViewHolder holder, final int position) {
      ...
      //  holder.textsub.setText(moviesubtitles.get(position).getUrl());
        ...
        holder.trailerurl.setText(movie1.getImage_url());
