...
public class LivestreamAdapter extends RecyclerView.Adapter<LivestreamAdapter.HomeViewHolder> {
    ...
    private VideoliveAdapter videoAdapter;
    ProgressDialog progressDialog;

    private RecyclerView.RecycledViewPool recycledViewPool;

    public LivestreamAdapter(ArrayList<HomeData> genre_movies, Context context) {
      ...
      //  holder.textViewCategory.setText(genre_movies.get(position).getGenreName());
        ...
        if(genre_movies.get(position).getMessage().equalsIgnoreCase("nodata")) {
           ...
           // holder.nodata.setText(genre_movies.get(position).getMessage());
            ...
            videoAdapter = new VideoliveAdapter(Arrays.asList(genre_movies.get(position).getVideos()), context);
