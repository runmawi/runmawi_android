...
public class VideoCategoryPageAdapter extends RecyclerView.Adapter<VideoCategoryPageAdapter.MovieViewHolder> {
    ...
    public VideoCategoryPageAdapter(List<videoss> list, Context context) {
        this.movieList = list;
