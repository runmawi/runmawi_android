...
public class VideoliveAdapter extends RecyclerView.Adapter<VideoliveAdapter.MovieViewHolder> {
    ...
    public VideoliveAdapter(List<videoss> list, Context context) {
        this.movieList = list;
                    ...
                    res.enqueue(new retrofit2.Callback<JSONResponse>() {
                        ...
                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                            ...
                            if (user_id == null) {
                                ...
                                else if (textsub.getText().toString().equalsIgnoreCase("subscriber")) {
