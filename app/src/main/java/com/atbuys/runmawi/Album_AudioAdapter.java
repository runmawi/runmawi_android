...
class Album_AudioAdapter extends RecyclerView.Adapter<Album_AudioAdapter.MyViewHolder> {
    ...
    public Album_AudioAdapter(ArrayList<audio> trendng_audioslist, Context context) {
    ...
    public Album_AudioAdapter(ArrayList<audio> trendng_audioslist) {
        this.trendng_audioslist = trendng_audioslist;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.audio_channel, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        Picasso.get().
                load( trendng_audioslist.get(position).getImage_url())
                .into(holder.image);
