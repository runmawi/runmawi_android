...
class All_AudioAdapter extends RecyclerView.Adapter<All_AudioAdapter.MyViewHolder> {



    private ArrayList<allaudios> trendng_audioslist;
    private Context context;




    public All_AudioAdapter(ArrayList<allaudios> trendng_audioslist, Context context) {
    ...
    public All_AudioAdapter(ArrayList<allaudios> trendng_audioslist) {
        this.trendng_audioslist = trendng_audioslist;
    }
