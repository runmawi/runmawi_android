...
class ArtistvideosAdapter extends RecyclerView.Adapter<ArtistvideosAdapter.MyViewHolder> {



    private ArrayList<video_artist> thismaylikelilst;
    private Context context;

    private static int currentPosition = 0;

    public ArtistvideosAdapter(ArrayList<video_artist> thismaylikelilst, Context context) {
    ...
    public ArtistvideosAdapter(ArrayList<video_artist> thismaylikelilst) {
        this.thismaylikelilst = thismaylikelilst;
    }
