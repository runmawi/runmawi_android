...
class AudioCategoryvideoAdapter extends RecyclerView.Adapter<AudioCategoryvideoAdapter.MyViewHolder> {



    private ArrayList<categoryaudio> thismaylikelilst;
    private Context context;

    private static int currentPosition = 0;

    public AudioCategoryvideoAdapter(ArrayList<categoryaudio> thismaylikelilst, Context context) {
        this.thismaylikelilst = thismaylikelilst;
        this.context = context;
    }

    public AudioCategoryvideoAdapter(ArrayList<categoryVideos> channelvideosdata, NotificationsFragment notificationsFragment) {
    }
    ...
    public AudioCategoryvideoAdapter(ArrayList<categoryaudio> thismaylikelilst) {
        this.thismaylikelilst = thismaylikelilst;
    }
