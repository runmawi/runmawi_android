...
class AudiosAdapter extends RecyclerView.Adapter<AudiosAdapter.MyViewHolder> {



    private ArrayList<audios> trendng_audioslist;
    private Context context;




    public AudiosAdapter(ArrayList<audios> trendng_audioslist, Context context) {
    ...
    public AudiosAdapter(ArrayList<audios> trendng_audioslist) {
        this.trendng_audioslist = trendng_audioslist;
    }
