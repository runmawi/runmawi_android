...
public class CategoryAudioPageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(CategoryAudioPageActivity.this, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override
                                        ...
                                        res.enqueue(new retrofit2.Callback<JSONResponse>() {
                                            ...
                                            public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                                                ...
                                                if (user_id == null) {
                                                    ...
                                                    in.putExtra("url", channelvideosdata.get(position).getImage_url());
                                                    startActivity(in);
