...
class Category_AudioAdapter extends RecyclerView.Adapter<Category_AudioAdapter.MyViewHolder> {



    private ArrayList<albumcategoryauido> trendng_audioslist;
    private Context context;




    public Category_AudioAdapter(ArrayList<albumcategoryauido> trendng_audioslist, Context context) {
    ...
    public Category_AudioAdapter(ArrayList<albumcategoryauido> trendng_audioslist) {
        this.trendng_audioslist = trendng_audioslist;
    }
