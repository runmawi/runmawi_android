...
class CategoryvideosAdapter extends RecyclerView.Adapter<CategoryvideosAdapter.MyViewHolder> {



    private ArrayList<video_categories> thismaylikelilst;
    private Context context;

    private static int currentPosition = 0;

    public CategoryvideosAdapter(ArrayList<video_categories> thismaylikelilst, Context context) {
    ...
    public CategoryvideosAdapter(ArrayList<video_categories> thismaylikelilst) {
        this.thismaylikelilst = thismaylikelilst;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.searchvideos, parent, false);
