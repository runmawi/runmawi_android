...
public class ChannalPageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<JSONResponse> channel = ApiClient.getInstance1().getApi().getChannelVideo(id);
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(ChannalPageActivity.this, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override
...
//                                                startActivity(in);
                                    ...
                                    res.enqueue(new retrofit2.Callback<JSONResponse>() {
                                        ...
                                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                                            ...
                                            JSONResponse jsonResponse = response.body();
                                        //    Toast.makeText(ChannalPageActivity.this, ""+user_id+"  "+channelvideosdata.get(position).getId(), Toast.LENGTH_SHORT).show();
