...
class ChannelListHomeAdapter extends RecyclerView.Adapter<ChannelListHomeAdapter.MyViewHolder> {
    ...
    public ChannelListHomeAdapter(ArrayList<audiocategories> channellists, Context context) {
    ...
    public ChannelListHomeAdapter(ArrayList<audiocategories> channellists) {
        this.channellistdata = channellists;
    }
