...
class ChannelListhomepageAdapter extends RecyclerView.Adapter<ChannelListhomepageAdapter.MyViewHolder> {

    private ArrayList<categorylist> channellistdata;
    private Context context;


    public ChannelListhomepageAdapter(ArrayList<categorylist> channellists, Context context) {
    ...
    public ChannelListhomepageAdapter(ArrayList<categorylist> channellists) {
        this.channellistdata = channellists;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.all_channel_home, parent, false);
