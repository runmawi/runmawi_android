...
class Channel_Category_Adapter extends RecyclerView.Adapter<Channel_Category_Adapter.MyViewHolder> {
    ...
    public Channel_Category_Adapter(ArrayList<categorylist> channellists, Context context) {
    ...
    public Channel_Category_Adapter(ArrayList<categorylist> channellists) {
        this.channellistdata = channellists;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        Picasso.get().
                load("https://flicknexsclubco.com/public/uploads/videocategory/" + channellistdata.get(position).getImage())
                .fit()
                .into(holder.image);
