...
public class ComingSoon extends AppCompatActivity {
    ...
    private ArrayList<categoryVideos> channelvideosdata;
    chennalCategoryvideoAdapter channelvideoAdapter;
    String id,name;
    TextView channelid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        channelvideosdata = new ArrayList<categoryVideos>();

        adapter = new chennalCategoryvideoAdapter(channelvideosdata, this);
        ...
        Call<JSONResponse> channel = ApiClient.getInstance1().getApi().getComingSoon();
        channel.enqueue(new retrofit2.Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                if (jsonResponse.getCategoryVideos().length == 0) {
                ...
                else
                {
                    ...
                    channelvideosdata = new ArrayList<>(Arrays.asList(jsonResponse.getCategoryVideos()));
                    channelvideoAdapter = new chennalCategoryvideoAdapter(channelvideosdata);
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(ComingSoon.this, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override
                    public void onItemClick(View view, final int position) {
                        ...
                        if (channelvideosdata.size() > position) {
...

                            {
                                ...
                                if(channelvideosdata.get(position).getType() ==null|| channelvideosdata.get(position).getType() =="")
                                {
                                    //Toast.makeText(ComingSoon.this, "id-> "+user_id+" id2-> "+channelvideosdata.get(position).getVideo_id(), Toast.LENGTH_SHORT).show();
                                    Call<JSONResponse> res = ApiClient.getInstance1().getApi().getMovieDetails(user_id, channelvideosdata.get(position).getVideo_id());
                                    res.enqueue(new retrofit2.Callback<JSONResponse>() {
                                        ...
                                        public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                                            ...
                                            if (user_id == null) {
                                                ...
                                                in.putExtra("id", channelvideosdata.get(position).getVideo_id());
...
//                                                startActivity(in);
                                    ...
                                    res.enqueue(new retrofit2.Callback<JSONResponse>() {
                                        ...
                                        public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                                            ...
                                            JSONResponse jsonResponse = response.body();
                                            //    Toast.makeText(ComingSoon.this, ""+user_id+"  "+channelvideosdata.get(position).getVideo_id(), Toast.LENGTH_SHORT).show();
