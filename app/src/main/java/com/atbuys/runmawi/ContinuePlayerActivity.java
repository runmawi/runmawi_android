...
// public class ContinuePlayerActivity extends AppCompatActivity implements View.OnClickListener, PlayerControlView.VisibilityListener, DownloadTracker.Listener , GestureDetector.OnGestureListener,
...
//     RemoveContinuWatching removeContinuWatching;
...
//         gestureDetector = new GestureDetector(ContinuePlayerActivity.this, ContinuePlayerActivity.this);
...
//                                /* Toast.makeText(getApplicationContext(), "Auto play turned off", Toast.LENGTH_LONG).show();
//                                 SharedPreferences.Editor editor = getSharedPreferences(sharedpreferences.My_preference_name, MODE_PRIVATE).edit();
//                                 editor.putString(share-dpreferences.autoplay, String.valueOf(0));
//                                 editor.apply();
//                                 editor.commit();
//                                 SharedPreferences prefs =getApplicationContext(). getSharedPreferences(sharedpreferences.My_preference_name, MODE_PRIVATE);
//                                 autoplay = prefs.getString(sharedpreferences.autoplay,null);*/
...
//                 if(  movie_detaildata.get(0).getType() == null || movie_detaildata.get(0).getType().equalsIgnoreCase(""))
//                 {
...
//                         else {
//                             subtitleDialog(ContinuePlayerActivity.this);
...
//     private void subtitleDialog(ContinuePlayerActivity onlineplayerActivity) {


//         dialog = new Dialog(ContinuePlayerActivity.this);
...
//         dialogsubformat = new Dialog(ContinuePlayerActivity.this);
//         // dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
...
//                         // or ViewGroup.LayoutParams.WRAP_CONTENT,
//                         ScreenUtils.convertDIPToPixels(ContinuePlayerActivity.this, PlayerView.LayoutParams.MATCH_PARENT)));
...
//         Bundle bundle = getIntent().getExtras();3
...
//             pDialog = new ProgressDialog(ContinuePlayerActivity.this);
...
//       /*  DownloadHelper downloadHelper = DownloadHelper.forDash(ContinuePlayerActivity.this, Uri.parse(urlll), dataSourceFactory, new DefaultRenderersFactory(ContinuePlayerActivity.this));
...
//         AlertDialog.Builder builder = new AlertDialog.Builder(ContinuePlayerActivity.this);
...
//                 ContinuePlayerActivity.this, // Context
...
//         player = ExoPlayerFactory.newSimpleInstance(*//* context= *//* ContinuePlayerActivity.this, renderersFactory, trackSelector, defaultLoadControl);
//         player.addListener(new PlayerEventListener());
//         player.setPlayWhenReady(startAutoPlay);
//         player.addAnalyticsListener(new EventLogger(trackSelector));
//         playerView.setPlayer(player);
...
//         if(textcomp.getText().toString().equalsIgnoreCase("completed"))
//         {
//             Api.getClient().getRemoveContinueWatching(user_id, videoId,  new Callback<Addtowishlistmovie>() {
