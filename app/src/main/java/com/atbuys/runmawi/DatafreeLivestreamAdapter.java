...
class DatafreeLivestreamAdapter extends RecyclerView.Adapter<DatafreeLivestreamAdapter.MyViewHolder> {



    private ArrayList<live_streams> latestvideoslist;
    ...
    public DatafreeLivestreamAdapter(ArrayList<live_streams> latestvideoslist, android.content.Context context) {
    ...
    public DatafreeLivestreamAdapter(ArrayList<live_streams> latestvideoslist) {
        this.latestvideoslist = latestvideoslist;
    }
