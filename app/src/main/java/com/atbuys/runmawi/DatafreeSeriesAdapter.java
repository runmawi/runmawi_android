...
class DatafreeSeriesAdapter extends RecyclerView.Adapter<DatafreeSeriesAdapter.MyViewHolder> {
    ...
    public DatafreeSeriesAdapter(ArrayList<series> latestvideoslist, Context context1) {
    ...
    public DatafreeSeriesAdapter(ArrayList<series> latestvideoslist) {
        this.latestvideoslist = latestvideoslist;
    }
