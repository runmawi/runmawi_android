...
class DatafreevideosAdapter extends RecyclerView.Adapter<DatafreevideosAdapter.MyViewHolder> {



    private ArrayList<videos> latestvideoslist;
    Context context;
    View itemView;
    ImageView hoverimg;
    ...
    public DatafreevideosAdapter(ArrayList<videos> latestvideoslist, Context context) {
    ...
    public DatafreevideosAdapter(ArrayList<videos> latestvideoslist) {
        this.latestvideoslist = latestvideoslist;
    }
