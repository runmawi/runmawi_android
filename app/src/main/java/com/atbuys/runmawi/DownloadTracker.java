  ...
  public void toggleDownload(
    ...
    if (download != null) {
      DownloadService.sendRemoveDownload(
          context, DemoDownloadService.class, download.request.id, */
/* foreground= *//*
 false);
    } else {
  ...
  private final class StartDownloadDialogHelper
    ...
    public void onPrepared(DownloadHelper helper) {
      ...
      mappedTrackInfo = downloadHelper.getMappedTrackInfo(*/
/* periodIndex= *//*
 0);
...
/* titleId= *//*
 R.string.exo_download_description, mappedTrackInfo, trackSelectorParameters,
              */
...
/* onDismissListener= *//*
 this);
      trackSelectionDialog.show(fragmentManager, */
/* tag= *//*
 null);
    }
    ...
    public void onClick(DialogInterface dialog, int which) {
      for (int periodIndex = 0; periodIndex < downloadHelper.getPeriodCount(); periodIndex++) {
        ...
        for (int i = 0; i < mappedTrackInfo.getRendererCount(); i++) {
          if (!trackSelectionDialog.getIsDisabled(*/
/* rendererIndex= *//*
 i)) {
...
/* rendererIndex= *//*
 i,
                ...
                trackSelectionDialog.getOverrides(*/
/* rendererIndex= *//*
 i));
          }
        }
    ...
    private void startDownload(DownloadRequest downloadRequest) {
      DownloadService.sendAddDownload(context, DemoDownloadService.class, downloadRequest, */
/* foreground= *//*
 false);
    }
