...
class EpisodesAdapter extends RecyclerView.Adapter<EpisodesAdapter.MyViewHolder> {



    private ArrayList<episodes> thismaylikelilst;
    private Context context;

    private static int currentPosition = 0;

    public EpisodesAdapter(ArrayList<episodes> thismaylikelilst, Context context) {
    ...
    public EpisodesAdapter(ArrayList<episodes> thismaylikelilst) {
        this.thismaylikelilst = thismaylikelilst;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
       ...
       // holder.name.setText(thismaylikelilst.get(position).getTitle());
        ...
        Picasso.get().
             load(thismaylikelilst.get(position).getImage()).fit().into(holder.image);
