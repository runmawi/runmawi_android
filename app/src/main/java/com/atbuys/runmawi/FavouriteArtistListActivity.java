...
public class FavouriteArtistListActivity extends AppCompatActivity {

    private ArrayList<favoriteslist> artistlistsdata;
    RecyclerView artistRecycler;
    ProgressBar artistProgress;
    Favourite_page_artistAdopter artistListAdopter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        artistlistsdata =new ArrayList<favoriteslist>();
        ...
        artistListAdopter = new Favourite_page_artistAdopter(artistlistsdata, this);
        ...
        Call<JSONResponse> channel = ApiClient.getInstance1().getApi().getFavouriteArtist(user_id);
        channel.enqueue(new retrofit2.Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                ...
                artistlistsdata = new ArrayList<>(Arrays.asList(jsonResponse.getFavoriteslist()));
                artistListAdopter = new Favourite_page_artistAdopter(artistlistsdata);
                artistRecycler.setAdapter(artistListAdopter);
        ...
        artistRecycler.addOnItemTouchListener(
                (RecyclerView.OnItemTouchListener) new RecyclerItemClickListener(FavouriteArtistListActivity.this, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override
                    public void onItemClick(View view, final int position) {
                        ...
                        if (artistlistsdata.size() > position) {
                            if (artistlistsdata.get(position) != null) {
                                ...
                                Intent in=new Intent(FavouriteArtistListActivity.this, ArtistPageActivity.class);
