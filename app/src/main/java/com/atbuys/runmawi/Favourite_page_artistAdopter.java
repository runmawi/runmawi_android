...
class Favourite_page_artistAdopter extends RecyclerView.Adapter<Favourite_page_artistAdopter.MyViewHolder> {
    ...
    public Favourite_page_artistAdopter(ArrayList<favoriteslist> favoriteslists, Context context) {
    ...
    public Favourite_page_artistAdopter(ArrayList<favoriteslist> favoriteslists) {
        this.favoriteslists = favoriteslists;
    }
