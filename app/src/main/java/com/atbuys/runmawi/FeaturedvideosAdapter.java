...
class FeaturedvideosAdapter extends RecyclerView.Adapter<FeaturedvideosAdapter.MyViewHolder> {



    private ArrayList<featured_videos> latestvideoslist;
    ...
    public FeaturedvideosAdapter(ArrayList<featured_videos> latestvideoslist, android.content.Context context) {
    ...
    public FeaturedvideosAdapter(ArrayList<featured_videos> latestvideoslist) {
        this.latestvideoslist = latestvideoslist;
    }
