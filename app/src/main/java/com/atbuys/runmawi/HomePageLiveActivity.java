...
@UnstableApi
public class HomePageLiveActivity extends AppCompatActivity implements View.OnClickListener, PlayerControlView.VisibilityListener,  PaymentResultListener, GestureDetector.OnGestureListener,
    ...
    private static HomePageLiveActivity mInstancee;
  ...
  //  DownloadActivity downloadActivity;
    ...
    RecyclerView castandcrewrecycler, related_recyclerview;
    LinearLayout castlayout;
    TextView related_text;
   // ExtractorsFactory extractorsFactory;
    ThismaylikeAdopter thismaylikeadopter;
    castandcrewadapter castandcrewadapter;
    RelatedLiveVideosAdapter relatedLiveVideosAdapter;
...
//        this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        ...
        gestureDetector = new GestureDetector(HomePageLiveActivity.this, HomePageLiveActivity.this);
...
//                /* foreground= */ false);
      ...
      //  cast = (ImageView) findViewById(R.id.cast);
            ...
            public void onClick(View v) {
                ...
                if (false){
                    ...
                    if (user_id == null) {
                        ...
                        dialog = new Dialog(HomePageLiveActivity.this);
                        ...
                        callimgg.enqueue(new retrofit2.Callback<JSONResponse>() {
                            ...
                            public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                                ...
                                wes.setLayoutManager(new GridLayoutManager(HomePageLiveActivity.this, 1));
                        ...
                        wes.addOnItemTouchListener(
                                new RecyclerItemClickListener(HomePageLiveActivity.this, new RecyclerItemClickListener.OnItemClickListener() {
                                    @Override
                        ...
                        btndialog.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (pays.getText().toString().equalsIgnoreCase("stripe")) {
                                    ...
                                    BottomSheetDialog dialog1 = new BottomSheetDialog(HomePageLiveActivity.this);
                                    ...
                                    paydunya_dialog = new BottomSheetDialog(HomePageLiveActivity.this);
                                    ...
                                    paydunya_pay_now.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            if (paydunya_email_address.getText().toString().isEmpty() || paydunya_email_address.getText().toString().trim().isEmpty()) {
                                                Toast.makeText(HomePageLiveActivity.this, "EMAIL ADDRESS not entered", Toast.LENGTH_SHORT).show();
                                            } else {
                                                Call<JSONResponse> call = ApiClient.getInstance1().getApi().getPaymentDetails();
                                                call.enqueue(new retrofit2.Callback<JSONResponse>() {
                                                    @Override
                                    ...
                                    dialog.dismiss();
                                    Intent intent=new Intent(HomePageLiveActivity.this, CheckoutActivity.class);
        ...
        relatedLiveVideosAdapter = new RelatedLiveVideosAdapter(livestreamArrayList, getApplicationContext());
        ...
        related_recyclerview = (RecyclerView) findViewById(R.id.related_recyclerview);
        ...
        related_recyclerview.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
        related_recyclerview.setAdapter(relatedLiveVideosAdapter);
...
//                                                startActivity(in);
        ...
        res1.enqueue(new retrofit2.Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                ...
                String userprofile = movie_detaildata.get(0).getPlayer_image();
...
*/
        ...
        Call<JSONResponse> related_api = ApiClient.getInstance1().getApi().getLiveRelatedVideos(videoId);
        related_api.enqueue(new retrofit2.Callback<JSONResponse>() {
            @Override
            public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                ...
                if (jsonResponse.getLivestreamNew().length == 0) {
                    ...
                    livestreamArrayList = new ArrayList<>(Arrays.asList(jsonResponse.getLivestreamNew()));
                    relatedLiveVideosAdapter = new RelatedLiveVideosAdapter(livestreamArrayList, getApplicationContext());
                    related_recyclerview.setAdapter(relatedLiveVideosAdapter);
                }
            }
        ...
        related_recyclerview.addOnItemTouchListener(new RecyclerItemClickListener(getApplicationContext(), new RecyclerItemClickListener.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent in = new Intent(getApplicationContext(), HomePageLiveActivity.class);
                in.putExtra("id", livestreamArrayList.get(position).getId());
                in.putExtra("url", "videourl");
                in.putExtra("xtra", "rentted");
        ...
        callimg.enqueue(new retrofit2.Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                ...
                if (!(jsonResponse.getCurrency_Converted().isEmpty())|| jsonResponse.getCurrency_Converted()!=null){
                    ...
                    Intent intent = new Intent(HomePageLiveActivity.this, PaymentActivity.class);
                    intent.putExtra(PayPalService.EXTRA_PAYPAL_CONFIGURATION, config);
        ...
        if (requestCode == PAYPAL_REQUEST_CODE) {
            ...
            if (confirm != null) {
                ...
                try {
                    ...
                    //Toast.makeText(HomePageLiveActivity.this, "Payment " + state + "\n with payment id is " + payID, Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(HomePageLiveActivity.this, "Error: " + e.getLocalizedMessage(), Toast.LENGTH_LONG).show();
                }
            } else if (requestCode == Activity.RESULT_CANCELED) {
                Toast.makeText(HomePageLiveActivity.this, "Payment Canceled", Toast.LENGTH_LONG).show();
            }
        } else if (requestCode == PaymentActivity.RESULT_EXTRAS_INVALID) {
            Toast.makeText(HomePageLiveActivity.this, "Invalid Payment", Toast.LENGTH_LONG).show();
        } else if (requestCode == Activity.RESULT_CANCELED) {
            Toast.makeText(HomePageLiveActivity.this, "Payment Canceled", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void transactionLog(){
        ...
        Call<JSONResponse1> trac_api=ApiClient.getInstance1().getApi().transactioLog(user_id,ppv_price,"ppv", "razorpay","android","1080p","",videoId,"","");
    ...
    public void prepareView() {
        playerView.setLayoutParams(
                new PlayerView.LayoutParams(
                        ...
                        // or ViewGroup.LayoutParams.WRAP_CONTENT,
                        ScreenUtils.convertDIPToPixels(HomePageLiveActivity.this, playerHeight)));
...
//        }
    ...
    private void fetchDownloadOptions() {
        ...
        if (pDialog == null || !pDialog.isShowing()) {
            pDialog = new ProgressDialog(HomePageLiveActivity.this);
      ...
      /*  DownloadHelper downloadHelper = DownloadHelper.forDash(HomePageLiveActivity.this, Uri.parse(urlll), dataSourceFactory, new DefaultRenderersFactory(HomePageLiveActivity.this));
    ...
    private void showDownloadOptionsDialog(DownloadHelper helper, List<TrackKey> trackKeyss) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(HomePageLiveActivity.this);
        ...
        ArrayAdapter arrayAdapter = new ArrayAdapter<String>(
                HomePageLiveActivity.this, // Context
...
//
//            //player = ExoPlayerFactory.newSimpleInstance(/* context= */ HomePageLiveActivity.this, renderersFactory, trackSelector, defaultLoadControl);
//            player.addListener(new PlayerEventListener());
...
*/
    ...
    public static synchronized HomePageLiveActivity getInstance() {
        return mInstancee;
    }
            ...
            pay_api.enqueue(new retrofit2.Callback<JSONResponse>() {
                ...
                public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                    ...
                    if (jsonResponse.getStatus().equalsIgnoreCase("true")){
                        Toast.makeText(HomePageLiveActivity.this, ""+jsonResponse.getMessage(), Toast.LENGTH_SHORT).show();
                        changeAccess();
                    }else {
                        Toast.makeText(HomePageLiveActivity.this, ""+jsonResponse.getMessage(), Toast.LENGTH_SHORT).show();
                    }
