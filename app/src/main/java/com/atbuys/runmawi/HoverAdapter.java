...
class HoverAdapter extends RecyclerView.Adapter<HoverAdapter.MyViewHolder> {
    ...
    public HoverAdapter(ArrayList<latestvideos> latestvideoslist, android.content.Context context) {
    ...
    public HoverAdapter(ArrayList<latestvideos> latestvideoslist) {
        this.latestvideoslist = latestvideoslist;
    }
