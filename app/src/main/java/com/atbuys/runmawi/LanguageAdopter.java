...
class LanguageAdopter extends RecyclerView.Adapter<LanguageAdopter.MyViewHolder> {
    ...
    public LanguageAdopter(ArrayList<all_languages> channellists, Context context) {
    ...
    public LanguageAdopter(ArrayList<all_languages> channellists) {
        this.channellistdata = channellists;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.all_language, parent, false);
