...
class LanguageSearchAdopter extends RecyclerView.Adapter<LanguageSearchAdopter.MyViewHolder> {
    ...
    public LanguageSearchAdopter(ArrayList<all_languages> channellists, Context context) {
    ...
    public LanguageSearchAdopter(ArrayList<all_languages> channellists) {
        this.channellistdata = channellists;
    }
