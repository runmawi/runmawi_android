...
class LatestvideosAdapter extends RecyclerView.Adapter<LatestvideosAdapter.MyViewHolder> {
    ...
    public LatestvideosAdapter(ArrayList<latestvideos> latestvideoslist, Context context) {
    ...
    public LatestvideosAdapter(ArrayList<latestvideos> latestvideoslist) {
        this.latestvideoslist = latestvideoslist;
    }
