...
public class LatestvideosPageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new LatestvideosAdapter(channelvideosdata, this);
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(LatestvideosPageActivity.this, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override
