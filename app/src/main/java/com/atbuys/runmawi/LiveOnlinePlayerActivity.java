...
@UnstableApi
public class LiveOnlinePlayerActivity extends AppCompatActivity implements View.OnClickListener, PlayerControlView.VisibilityListener, PaymentResultListener, GestureDetector.OnGestureListener,
...
//        this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        ...
        gestureDetector = new GestureDetector(LiveOnlinePlayerActivity.this, LiveOnlinePlayerActivity.this);
      ...
      //  dataSourceFactory = buildDataSourceFactory();
        ...
        setContentView(R.layout.activity_live_online_player);
        ...
        text_urll = findViewById(R.id.urll);
        text_idd = findViewById(R.id.idddd);

        text_urll.setText(urlll);
        text_idd.setText(videoId);
...
//                /* foreground= */ false);
        ...
        xprevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dataa.equalsIgnoreCase("watchlater")) {
                    Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getWatchlatertPrev(user_id, text_idd.getText().toString());
                    ...
                    Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getfavouritePrev(user_id, text_idd.getText().toString());
                    alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                        @Override
                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                    ...
                    Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getWishlistPrev(user_id, text_idd.getText().toString());
                    alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                        @Override
                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                    ...
                    Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getPrev_video(text_idd.getText().toString());
                    alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                        @Override
                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
        ...
        xnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dataa.equalsIgnoreCase("watchlater")) {
                    Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getWatchlatertNext(user_id, text_idd.getText().toString());
                    alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                        @Override
                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                    ...
                    Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getfavouriteNext(user_id, text_idd.getText().toString());
                    alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                        @Override
                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                    ...
                    Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getWishlistNext(user_id, text_idd.getText().toString());
                    alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                        @Override
                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                    ...
                    Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getNext_video(text_idd.getText().toString());
                    alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                        @Override
                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
        ...
        comments.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (commentlayout.getVisibility() == View.VISIBLE) {
                    ...
                    Call<JSONResponse> movieres = ApiClient.getInstance1().getApi().getUsercomments(text_idd.getText().toString());
        ...
        commentsend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Api.getClient().getAddcomment(user_id, text_idd.getText().toString(), comment, new Callback<AddComment>() {
        ...
        watchlater.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {

                {
                    ...
                    Api.getClient().getAddwatchlater(user_id, text_idd.getText().toString(), type, new Callback<Addtowishlistmovie>() {
        ...
        watchlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {

                {
                    ...
                    Api.getClient().getAddWishlistMovie(user_id, text_idd.getText().toString(), type, new Callback<Addtowishlistmovie>() {
        ...
        likee.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {

                {
                    ...
                    Api.getClient().getlikeandunlike(user_id, text_idd.getText().toString(), "1", new Callback<likeandunlike>() {
        ...
        unlikelayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {

                {
                    ...
                    Api.getClient().getlikeandunlike(user_id, text_idd.getText().toString(), "0", new Callback<likeandunlike>() {
        ...
        dislike.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {

                {
                    ...
                    Api.getClient().getDislikecount(user_id, text_idd.getText().toString(), "1", new Callback<likeandunlike>() {
        ...
        undislikelayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {

                {
                    ...
                    Api.getClient().getDislikecount(user_id, text_idd.getText().toString(), "0", new Callback<likeandunlike>() {
        ...
        alert = new AlertDialog.Builder(LiveOnlinePlayerActivity.this);
        ...
        access.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog = new Dialog(LiveOnlinePlayerActivity.this);
                ...
                callimgg.enqueue(new retrofit2.Callback<JSONResponse>() {
                    ...
                    public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                        ...
                        wes.setLayoutManager(new GridLayoutManager(LiveOnlinePlayerActivity.this, 1));
                ...
                wes.addOnItemTouchListener(
                        new RecyclerItemClickListener(LiveOnlinePlayerActivity.this, new RecyclerItemClickListener.OnItemClickListener() {
                            @Override
                ...
                btndialog.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (pays.getText().toString().equalsIgnoreCase("stripe")) {
                            ...
                            BottomSheetDialog dialog1 = new BottomSheetDialog(LiveOnlinePlayerActivity.this);
                                    ...
                                    if (!check.isChecked()) {
                                        ...
                                        stripe.createPaymentMethod(params, new ApiResultCallback<PaymentMethod>() {
                                            ...
                                            public void onSuccess(@NotNull PaymentMethod paymentMethod) {
                                                ...
                                                Api.getClient().getAddPayperViewLive(user_id, videoId, py_id, "stripe", ppv_price, "Android", new Callback<Addpayperview>() {
    ...
    public void onPaymentSuccess(String s) {
        ...
        Api.getClient().getAddPayperViewLive(user_id, videoId, "", "razorpay", ppv_price, "Android", new Callback<Addpayperview>() {
...
*/
    ...
    private void ThisMayAlsoLikeVideos() {
       ...
       /* Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getAlsolikeVideo(text_idd.getText().toString());
        alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
            @Override
            public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
...
*/
    ...
    private void VideoDetails() {
        ...
        Call<JSONResponse> res = ApiClient.getInstance1().getApi().getLiveDetail(user_id, text_idd.getText().toString());
        res.enqueue(new retrofit2.Callback<JSONResponse>() {
            @Override
            public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                ...
                videoThumb.getDrawable();
                playerView.setDefaultArtwork(videoThumb.getDrawable());
...
*/
                ...
                if (movie_detaildata.get(0).getLivestream_format().equalsIgnoreCase("Encode_video")) {
                    urlll = movie_detaildata.get(0).getHls_url();
                    text_urll.setText(urlll);
                } else if (movie_detaildata.get(0).getLivestream_format().equalsIgnoreCase("m3u_url")) {
               ...
               /* else if(movie_detaildata.get(0).getType().equalsIgnoreCase("Encode_video"))
                {
...
*/
                ...
                if (current_time_update != 0) {
                    mediaSource = buildMediaSource(Uri.parse(text_urll.getText().toString()));
                    //player.prepare(mediaSource);
    ...
    private void observerVideoStatus() {
        if (downloadManager.getCurrentDownloads().size() > 0) {
            for (int i = 0; i < downloadManager.getCurrentDownloads().size(); i++) {
                ...
                if (!text_urll.getText().toString().isEmpty() && currentDownload.request.uri.equals(parse(text_urll.getText().toString()))) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            if (downloadTracker.downloads.size() > 0) {
                                if (currentDownload.request.uri.equals(parse(text_urll.getText().toString()))) {

                                    Download downloadFromTracker = downloadTracker.downloads.get(parse(text_urll.getText().toString()));
...
*/
      ...
      //  playerView.setErrorMessageProvider(new PlayerErrorMessageProvider());
        ...
        subtitle_on.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Call<JSONResponse> res = ApiClient.getInstance1().getApi().getMovieDetails(user_id, text_idd.getText().toString());
                res.enqueue(new retrofit2.Callback<JSONResponse>() {
                    @Override
                    public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                        ...
                        if (jsonResponse.getmoviesubtitles().length == 0) {
                            ...
                            subtitleDialog(LiveOnlinePlayerActivity.this);
    ...
    private void subtitleDialog(LiveOnlinePlayerActivity onlineplayerActivity) {
                    ...
                    public void onItemClick(View view, final int position) {
                        ...
                        if (moviesubtitlesdata.size() > position) {
                            if (moviesubtitlesdata.get(position) != null) {
                                ...
                                MediaSource contentMediaSource = buildMediaSource1(Uri.parse(text_urll.getText().toString()));
                                MediaSource[] mediaSources = new MediaSource[2]; //The Size must change depending on the Uris
                                mediaSources[0] = contentMediaSource; // uri
                                //Add subtitles
                               /* SingleSampleMediaSource subtitleSource = new SingleSampleMediaSource(subUri, dataSourceFactory,
    ...
    private void showsubtitlestyles() {
        ...
        dialogsubformat = new Dialog(LiveOnlinePlayerActivity.this);
        // dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    public void prepareView() {
      /*  playerView.setLayoutParams(
                new PlayerView.LayoutParams(
                        // or ViewGroup.LayoutParams.WRAP_CONTEN
                        PlayerView.LayoutParams.MATCH_PARENT,
                        // or ViewGroup.LayoutParams.WRAP_CONTENT,
                        ScreenUtils.convertDIPToPixels(LiveOnlinePlayerActivity.this, PlayerView.LayoutParams.MATCH_PARENT)));
*/
...
//                }
    ...
    private void exoVideoDownloadDecision(ExoDownloadState exoDownloadState) {
        if (exoDownloadState == null || text_urll.getText().toString().isEmpty()) {
        ...
        switch (exoDownloadState) {
           ...
           //     downloadManager.addDownload(downloadTracker.getDownloadRequest(Uri.parse(text_urll.getText().toString())), Download.STATE_STOPPED);
...
//                        /* foreground= */ false);
            ...
            case DOWNLOAD_RESUME:
              ...
              //  downloadManager.addDownload(downloadTracker.getDownloadRequest(Uri.parse(text_urll.getText().toString())), Download.STOP_REASON_NONE);
//                DownloadService.sendSetStopReason(
//                        OnlinePlayerActivity.this,
//                        DemoDownloadService.class,
//                        downloadTracker.getDownloadRequest(Uri.parse(text_urll.getText().toString())).id,
...
//        if (downloadTracker.downloads.size() > 0) {
//            Download download = downloadTracker.downloads.get(Uri.parse(text_urll.getText().toString()));
//
//            if (download != null) {
...
//        }
    ...
    private void fetchDownloadOptions() {
        ...
        if (pDialog == null || !pDialog.isShowing()) {
            pDialog = new ProgressDialog(LiveOnlinePlayerActivity.this);
       ...
       /* DownloadHelper downloadHelper = DownloadHelper.forDash(LiveOnlinePlayerActivity.this, Uri.parse(text_urll.getText().toString()), dataSourceFactory, new DefaultRenderersFactory(LiveOnlinePlayerActivity.this));
    ...
    private void showDownloadOptionsDialog(DownloadHelper helper, List<TrackKey> trackKeyss) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(LiveOnlinePlayerActivity.this);
        ...
        ArrayAdapter arrayAdapter = new ArrayAdapter<String>(
                LiveOnlinePlayerActivity.this, // Context
...
//                        TrackGroupArray rendererTrackGroups = mappedTrackInfo.getTrackGroups(i);
                ...
                DownloadRequest downloadRequest = helper.getDownloadRequest(Util.getUtf8Bytes(text_urll.getText().toString()));
...
//                    Uri.parse(text_urll.getText().toString()),
...
/*
    ...
    private void initializePlayer() {
        ...
        player = ExoPlayerFactory.newSimpleInstance(*//* context= *//* LiveOnlinePlayerActivity.this, renderersFactory, trackSelector, defaultLoadControl);
        player.addListener(new PlayerEventListener());
        player.setPlayWhenReady(startAutoPlay);
        player.addAnalyticsListener(new EventLogger(trackSelector));
        playerView.setPlayer(player);
...
*//*
        ...
        {*//*
        mediaSource = buildMediaSource2(Uri.parse(text_urll.getText().toString()));
    ...
    public void onDownloadsChanged(Download download) {
        switch (download.state) {
            ...
            case STATE_COMPLETED:
                ...
                if (download.request.uri.toString().equals(text_urll.getText().toString())) {
