...
public class recommandedd {

    private String title,url_type, video_id, ppv_status, image_url,id, hls_url;
    private String image, mobile_image, trailer, video_url, mp4_url, path,access,rating;
