...
class MostwatchedCountryAdapter extends RecyclerView.Adapter<MostwatchedCountryAdapter.MyViewHolder> {



    private ArrayList<Mostwatched> latestvideoslist;
    Context context;
    View itemView;
    ImageView hoverimg;
    ...
    public MostwatchedCountryAdapter(ArrayList<Mostwatched> latestvideoslist, Context context) {
    ...
    public MostwatchedCountryAdapter(ArrayList<Mostwatched> latestvideoslist) {
        this.latestvideoslist = latestvideoslist;
    }
