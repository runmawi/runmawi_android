...
class MostwatchedvideosAdapter extends RecyclerView.Adapter<MostwatchedvideosAdapter.MyViewHolder> {



    private ArrayList<Mostwatchedvideos> latestvideoslist;
    Context context;
    View itemView;
    ImageView hoverimg;
    ...
    public MostwatchedvideosAdapter(ArrayList<Mostwatchedvideos> latestvideoslist, Context context) {
    ...
    public MostwatchedvideosAdapter(ArrayList<Mostwatchedvideos> latestvideoslist) {
        this.latestvideoslist = latestvideoslist;
    }
