...
class MyFavouriteepisodeAdopter extends RecyclerView.Adapter<MyFavouriteepisodeAdopter.MyViewHolder> {
    ...
    public MyFavouriteepisodeAdopter(ArrayList<channel_audios> channelaudiolist, Context context) {
    ...
    public MyFavouriteepisodeAdopter(ArrayList<channel_audios> channelaudiolist) {
        this.channelaudiolist = channelaudiolist;
    }
