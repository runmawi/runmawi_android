...
class NewContinueWatchingAdopter extends RecyclerView.Adapter<NewContinueWatchingAdopter.MyViewHolder>  {
    ...
    public NewContinueWatchingAdopter(ArrayList<videos> continuevideolist, Context context) {
    ...
    public NewContinueWatchingAdopter(ArrayList<videos> continuevideolist) {
        this.continuevideolist = continuevideolist;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.new_continuewatching, parent, false);
