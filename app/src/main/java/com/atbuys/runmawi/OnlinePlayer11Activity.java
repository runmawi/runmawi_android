...
@UnstableApi
public class OnlinePlayer11Activity extends AppCompatActivity implements View.OnClickListener, PlayerControlView.VisibilityListener, GestureDetector.OnGestureListener,
    ...
    private int intro_start_time,intro_end_time,recap_start_time,recap_end_time;
   ...
   // private DownloadTracker downloadTracker;
    ...
    TextView videotext,nextep,prevep;
    LinearLayout share;
    TextView videotitle1,language1,genre2,duration,year,getCast1;
    String shareurl,user_id,subtitles_text,subchecked1,subchecked2,subchecked3,subchecked4;
...
//        this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        ...
        gestureDetector = new GestureDetector(OnlinePlayer11Activity.this, OnlinePlayer11Activity.this);
      ...
      //  dataSourceFactory = buildDataSourceFactory();
        ...
        setContentView(R.layout.activity_online_player11);
        ...
        //  urlll = "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4";
...
//                /* foreground= */ false);
        ...
        prevep = (TextView) findViewById(R.id.prevepisode);
        ...
        prevep.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {



                Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getNext_Episode(videoId, seasonid);
                alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                    ...
                    public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                        ...
                        if (jsonResponse.getStatus().equalsIgnoreCase("true")) {
                            videoId = jsonResponse.getNext_episodeid();
                            VideoDetails();
                            //   ThisMayAlsoLikeVideos();
                        } else {

                            prevep.setVisibility(View.GONE);
                            nextep.setVisibility(View.VISIBLE);
                        }
                    }
        ...
        nextep.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                    ...
                    public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                        ...
                        if (jsonResponse.getStatus().equalsIgnoreCase("true")) {
                            ...
                            nextep.setVisibility(View.GONE);
                            prevep.setVisibility(View.VISIBLE);
                        }
                    }
        ...
        xnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dataa.equalsIgnoreCase("watchlater")) {
                    Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getWatchlatertNextEpisode(user_id, videoId);
                    alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                        @Override
                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                    ...
                    Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getfavouriteNextEpisode(user_id, videoId);
                    alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                        @Override
                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                    ...
                    Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getWishlistNextEpisode(user_id, videoId);
                    alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                        @Override
                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                    ...
                    Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getNext_Episode(videoId, "");
                    alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                        @Override
                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
        ...
        xprevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (dataa.equalsIgnoreCase("watchlater")) {
                    Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getWatchlatertPrevEpisode(user_id, videoId);
                    alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                        @Override
                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                    ...
                    Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getfavouritePrevEpisode(user_id, videoId);
                    alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                        @Override
                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                    ...
                    Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getWishlistPrevEpisode(user_id, videoId);
                    alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                        @Override
                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                    ...
                    Call<JSONResponse> alsolikeres = ApiClient.getInstance1().getApi().getPrev_Episode(videoId, "");
                    alsolikeres.enqueue(new retrofit2.Callback<JSONResponse>() {
                        @Override
                        public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
...
*/
      ...
      /*  if (autoplay == null | autoplay.equalsIgnoreCase("0")) {
    ...
    private void VideoDetails() {
        ...
        res.enqueue(new retrofit2.Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                ...
                nxtvidid = jsonResponse.getNext_episodeid();
                ...
                if (movie_detaildata.get(0).getType().equalsIgnoreCase("m3u8")) {
                    urlll = movie_detaildata.get(0).getEpisode_url();
                } else if (movie_detaildata.get(0).getType().equalsIgnoreCase("bunny_cdn")) {
                    urlll = movie_detaildata.get(0).getUrl();
                } else {
                    urlll = movie_detaildata.get(0).getMp4_url();
                }


                /*if(movie_detaildata.get(0).getIntro_start_time() == null) {
                    intro_start_time = 0;
                } else {
                    intro_start_time = Integer.parseInt(movie_detaildata.get(0).getIntro_start_time()) * 1000;
                }if(movie_detaildata.get(0).getIntro_end_time() == null) {
                    intro_end_time = 0;
                } else {
                    intro_end_time = Integer.parseInt(movie_detaildata.get(0).getIntro_end_time()) * 1000;
                }if(movie_detaildata.get(0).getRecap_start_time() == null) {
                    recap_start_time = 0;
                } else {
                    recap_start_time = Integer.parseInt(movie_detaildata.get(0).getRecap_start_time()) * 1000;
                }*/


                if(movie_detaildata.get(0).getRecap_end_time() == null)
                {
                ...
                {
                    recap_end_time = Integer.parseInt(movie_detaildata.get(0).getRecap_end_time()) * 1000;
            ...
            /*    ha   = new Handler();
                has = new Runnable() {
                    ...
                    public void run() {
                        ...
                        else if (player.getCurrentPosition() > intro_start_time && player.getCurrentPosition() < intro_end_time) {
                        ...
                        else if (player.getCurrentPosition() > recap_start_time  && player.getCurrentPosition() < recap_end_time) {
                    ...
                    *//*    if (player.getCurrentPosition() > intro_end_time || player.getCurrentPosition() > recap_end_time) {
...
//    }
                ...
                res.enqueue(new retrofit2.Callback<JSONResponse>() {
                    ...
                    public void onResponse(Call<JSONResponse> call, retrofit2.Response<JSONResponse> response) {
                        ...
                        if(jsonResponse.getmoviesubtitles().length == 0 )
                        {
                            ...
                            subtitleDialog(OnlinePlayer11Activity.this);
    ...
    private void subtitleDialog(OnlinePlayer11Activity onlineplayerActivity) {


        dialog = new Dialog(OnlinePlayer11Activity.this);
    ...
    private void showsubtitlestyles() {
        ...
        dialogsubformat = new Dialog(OnlinePlayer11Activity.this);
        // dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    public void prepareView() {
      /*  playerView.setLayoutParams(
                new PlayerView.LayoutParams(
                        ...
                        // or ViewGroup.LayoutParams.WRAP_CONTENT,
                        ScreenUtils.convertDIPToPixels(OnlinePlayer11Activity.this, PlayerView.LayoutParams.MATCH_PARENT)));
*/
...
//        }
    ...
    private void fetchDownloadOptions() {
        ...
        if (pDialog == null || !pDialog.isShowing()) {
            pDialog = new ProgressDialog(OnlinePlayer11Activity.this);
      ...
      /*  DownloadHelper downloadHelper = DownloadHelper.forDash(OnlinePlayer11Activity.this, Uri.parse(urlll), dataSourceFactory, new DefaultRenderersFactory(OnlinePlayer11Activity.this));
    ...
    private void showDownloadOptionsDialog(DownloadHelper helper, List<TrackKey> trackKeyss) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(OnlinePlayer11Activity.this);
        ...
        ArrayAdapter arrayAdapter = new ArrayAdapter<String>(
                OnlinePlayer11Activity.this, // Context
...
/* context= *//*
 OnlinePlayer11Activity.this, renderersFactory, trackSelector, defaultLoadControl);
        player.addListener(new PlayerEventListener());
        player.setPlayWhenReady(startAutoPlay);
        player.addAnalyticsListener(new EventLogger(trackSelector));
        playerView.setPlayer(player);
    ...
    private void releasePlayer() {
        ...
        if (player != null) {
            ...
            if (x < 0) {
                ...
                Api.getClient().getContinueWatchingEpisode(user_id, videoId, String.valueOf(y), String.valueOf(w), new Callback<ContinuWatching>() {
