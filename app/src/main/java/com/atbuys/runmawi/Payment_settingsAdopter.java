...
public class Payment_settingsAdopter extends RecyclerView.Adapter<Payment_settingsAdopter.ViewHolder> {
    private ArrayList<payment_settings> plans;

    private int lastPosition = -1;
    int row_index = 0;
    private Context context;

    public Payment_settingsAdopter(ArrayList<payment_settings> plans) {
        this.plans = plans;
    }
