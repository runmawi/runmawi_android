...
public class Refercode12Adopter extends RecyclerView.Adapter<Refercode12Adopter.ViewHolder> {
    private ArrayList<myrefferals> plans;
    int row_index = -1;
    Context context;

    public Refercode12Adopter(ArrayList<myrefferals> plans) {
        this.plans = plans;
    }

    public Refercode12Adopter(ArrayList<myrefferals> myrefferallist, UpgradeSupscriptionPaymentActivity upgradeSupscriptionPaymentActivity) {
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.tv_interval.setText(plans.get(i).getCoupon_code());
