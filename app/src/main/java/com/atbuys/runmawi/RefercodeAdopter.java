...
public class RefercodeAdopter extends RecyclerView.Adapter<RefercodeAdopter.ViewHolder> {
    private ArrayList<myrefferals> plans;
    int row_index = -1;
    Context context;

    public RefercodeAdopter(ArrayList<myrefferals> plans) {
        this.plans = plans;
    }

    public RefercodeAdopter(ArrayList<myrefferals> myrefferallist, UpgradeSupscriptionPaymentActivity upgradeSupscriptionPaymentActivity) {
    }
