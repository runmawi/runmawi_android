...
class RelatedEpisodeAdapter extends RecyclerView.Adapter<RelatedEpisodeAdapter.MyViewHolder> {
    ...
    public RelatedEpisodeAdapter(ArrayList<related_episode> thismaylikelilst, Context context) {
    ...
    public RelatedEpisodeAdapter(ArrayList<related_episode> thismaylikelilst) {
        this.thismaylikelilst = thismaylikelilst;
    }
