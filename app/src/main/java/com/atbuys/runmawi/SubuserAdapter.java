...
class SubuserAdapter extends RecyclerView.Adapter<SubuserAdapter.MyViewHolder> {



    private ArrayList<sub_users> latestvideoslist;
    ...
    public SubuserAdapter(ArrayList<sub_users> latestvideoslist, android.content.Context context) {
    ...
    public SubuserAdapter(ArrayList<sub_users> latestvideoslist) {
        this.latestvideoslist = latestvideoslist;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
         itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.sub_user, parent, false);
