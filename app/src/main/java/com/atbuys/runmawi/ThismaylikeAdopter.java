...
class ThismaylikeAdopter extends RecyclerView.Adapter<ThismaylikeAdopter.MyViewHolder> {
    ...
    private ArrayList<channelrecomended> thismaylikelilst;
    private Context context;

    private static int currentPosition = 0;

    public ThismaylikeAdopter(ArrayList<channelrecomended> thismaylikelilst, Context context) {
    ...
    public ThismaylikeAdopter(ArrayList<channelrecomended> thismaylikelilst) {
        this.thismaylikelilst = thismaylikelilst;
    }
