...
class ThismaylikeppvAdopter extends RecyclerView.Adapter<ThismaylikeppvAdopter.MyViewHolder> {



    private ArrayList<ppvrecomended> thismaylikelilst;
    private Context context;

    private static int currentPosition = 0;

    public ThismaylikeppvAdopter(ArrayList<ppvrecomended> thismaylikelilst, Context context) {
    ...
    public ThismaylikeppvAdopter(ArrayList<ppvrecomended> thismaylikelilst) {
        this.thismaylikelilst = thismaylikelilst;
    }
