...
//  }
//
//  private static boolean willHaveContent(MappingTrackSelector.MappedTrackInfo mappedTrackInfo) {
//  }
//
//  /**
//   * Returns whether a track selection dialog will have content to display if initialized with the
...
//      View rootView =
//          inflater.inflate(R.layout.exo_track_selection_dialog, container, /* attachToRoot= */ false);
//      TrackSelectionView trackSelectionView = rootView.findViewById(R.id.exo_track_selection_view);
//
//      trackSelectionView.setShowDisableOption(false); // disable the disable option in dialog
