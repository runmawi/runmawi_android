...
class Trending_AudioAdapter extends RecyclerView.Adapter<Trending_AudioAdapter.MyViewHolder> {



    private ArrayList<trending_audios> trendng_audioslist;
    private Context context;




    public Trending_AudioAdapter(ArrayList<trending_audios> trendng_audioslist, Context context) {
    ...
    public Trending_AudioAdapter(ArrayList<trending_audios> trendng_audioslist) {
        this.trendng_audioslist = trendng_audioslist;
    }
