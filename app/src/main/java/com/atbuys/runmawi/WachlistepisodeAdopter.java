...
class WachlistepisodeAdopter extends RecyclerView.Adapter<WachlistepisodeAdopter.MyViewHolder> {
    ...
    public WachlistepisodeAdopter(ArrayList<episode> wishlistlilst, Context context) {
    ...
    public WachlistepisodeAdopter(ArrayList<episode> wishlistlilst) {
        this.wishlistlilst = wishlistlilst;
    }
