...
class WishlaterAdopter extends RecyclerView.Adapter<WishlaterAdopter.MyViewHolder> {
    ...
    public WishlaterAdopter(ArrayList<channel_videos> wishlistlilst, Context context) {
    ...
    public WishlaterAdopter(ArrayList<channel_videos> wishlistlilst) {
        this.wishlistlilst = wishlistlilst;
    }
