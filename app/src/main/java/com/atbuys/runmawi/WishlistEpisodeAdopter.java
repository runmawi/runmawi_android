...
class WishlistEpisodeAdopter extends RecyclerView.Adapter<WishlistEpisodeAdopter.MyViewHolder> {



    private ArrayList<episode> wishlistlilst;
    private Context context;

    private static int currentPosition = 0;

    public WishlistEpisodeAdopter(ArrayList<episode> wishlistlilst, Context context) {
    ...
    public WishlistEpisodeAdopter(ArrayList<episode> wishlistlilst) {
        this.wishlistlilst = wishlistlilst;
    }
