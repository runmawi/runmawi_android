...
class banner1Adopter extends RecyclerView.Adapter<banner1Adopter.MyViewHolder> {



    private ArrayList<live_banner> latestvideoslist;
    Context context;
    View itemView;
    ImageView hoverimg;
    ...
    public banner1Adopter(ArrayList<live_banner> latestvideoslist, Context context) {
    ...
    public
    banner1Adopter(ArrayList<live_banner> latestvideoslist) {
        this.latestvideoslist = latestvideoslist;
    }
