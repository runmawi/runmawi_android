...
class channelvideosadapter extends RecyclerView.Adapter<channelvideosadapter.MyViewHolder> {



    private ArrayList<channelvideos> thismaylikelilst;
    private Context context;

    private static int currentPosition = 0;

    public channelvideosadapter(ArrayList<channelvideos> thismaylikelilst, Context context) {
    ...
    public channelvideosadapter(ArrayList<channelvideos> thismaylikelilst) {
        this.thismaylikelilst = thismaylikelilst;
    }
