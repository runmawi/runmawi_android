...
class chennalCategoryAdapter extends RecyclerView.Adapter<chennalCategoryAdapter.MyViewHolder> {



    private ArrayList<channel_category> thismaylikelilst;
    private Context context;


    private static int currentPosition = 0;

    public chennalCategoryAdapter(ArrayList<channel_category> thismaylikelilst, Context context) {
    ...
    public chennalCategoryAdapter(ArrayList<channel_category> thismaylikelilst) {
        this.thismaylikelilst = thismaylikelilst;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
      ...
      //  holder.id.setText(thismaylikelilst.get(position).getId());
       // holder.url.setText(thismaylikelilst.get(position).getMp4_url());
        holder.name.setText(thismaylikelilst.get(position).getName());
