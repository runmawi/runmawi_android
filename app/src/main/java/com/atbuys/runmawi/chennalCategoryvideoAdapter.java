...
class chennalCategoryvideoAdapter extends RecyclerView.Adapter<chennalCategoryvideoAdapter.MyViewHolder> {



    private ArrayList<categoryVideos> thismaylikelilst;
    private Context context;

    private static int currentPosition = 0;

    public chennalCategoryvideoAdapter(ArrayList<categoryVideos> thismaylikelilst, Context context) {
        this.thismaylikelilst = thismaylikelilst;
        this.context = context;
    }

    public chennalCategoryvideoAdapter(ArrayList<categoryVideos> channelvideosdata, NotificationsFragment notificationsFragment) {
    }
    ...
    public chennalCategoryvideoAdapter(ArrayList<categoryVideos> thismaylikelilst) {
        this.thismaylikelilst = thismaylikelilst;
    }
