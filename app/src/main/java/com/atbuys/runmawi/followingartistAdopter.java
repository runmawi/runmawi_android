...
class followingartistAdopter extends RecyclerView.Adapter<followingartistAdopter.MyViewHolder> {
    ...
    public followingartistAdopter(ArrayList<followinglist> followinglists, Context context) {
    ...
    public followingartistAdopter(ArrayList<followinglist> followinglists) {
        this.followinglists = followinglists;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        Picasso.get()
                .load("https://exlhoster.com/public/uploads/artists/"+followinglists.get(position).getImage())
