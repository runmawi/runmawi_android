...
class latest_channal_videosAdapter extends RecyclerView.Adapter<latest_channal_videosAdapter.MyViewHolder> {



    private ArrayList<latest_video> latestvideoslist;
    ...
    public latest_channal_videosAdapter(ArrayList<latest_video> latestvideoslist, android.content.Context context) {
    ...
    public latest_channal_videosAdapter(ArrayList<latest_video> latestvideoslist) {
        this.latestvideoslist = latestvideoslist;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        if (latestvideoslist.get(position).getRating()==null ||latestvideoslist.get(position).getRating()=="" ||latestvideoslist.get(position).getRating()=="0"){
            holder.ratingcard.setVisibility(View.GONE);
        }else {
            holder.rating.setText(latestvideoslist.get(position).getRating()+". 0");
        }
