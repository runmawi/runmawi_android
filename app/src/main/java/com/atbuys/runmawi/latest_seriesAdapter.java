...
class latest_seriesAdapter extends RecyclerView.Adapter<latest_seriesAdapter.MyViewHolder> {



    private ArrayList<latest_series> latestvideoslist;
    ...
    public latest_seriesAdapter(ArrayList<latest_series> latestvideoslist, Context context1) {
    ...
    public latest_seriesAdapter(ArrayList<latest_series> latestvideoslist) {
        this.latestvideoslist = latestvideoslist;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.series, parent, false);
