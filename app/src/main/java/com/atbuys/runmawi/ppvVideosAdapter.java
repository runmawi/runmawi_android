...
class ppvVideosAdapter extends RecyclerView.Adapter<ppvVideosAdapter.MyViewHolder> {



    private ArrayList<ppv_videos> thismaylikelilst;
    private Context context;

    private static int currentPosition = 0;

    public ppvVideosAdapter(ArrayList<ppv_videos> thismaylikelilst, Context context) {
    ...
    public ppvVideosAdapter(ArrayList<ppv_videos> thismaylikelilst) {
        this.thismaylikelilst = thismaylikelilst;
    }
