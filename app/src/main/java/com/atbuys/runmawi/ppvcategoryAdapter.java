...
class ppvcategoryAdapter extends RecyclerView.Adapter<ppvcategoryAdapter.MyViewHolder> {



    private ArrayList<ppv_category> thismaylikelilst;
    private Context context;

    private static int currentPosition = 0;

    public ppvcategoryAdapter(ArrayList<ppv_category> thismaylikelilst, Context context) {
    ...
    public ppvcategoryAdapter(ArrayList<ppv_category> thismaylikelilst) {
        this.thismaylikelilst = thismaylikelilst;
    }
